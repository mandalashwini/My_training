var signup_module = (function(){
    ...
    var data;
        ...
        var fetchDetails = function (){
            ...
            profession=document.getElementById('profession').selectedIndex
         ...
         if(validate_mobilenumber())
	{
        ...
        function unique_emailid()
        {
            ...
            s_emailid=document.getElementById("emailid").value;
           for(var i=0; i<data_array.length; i++)
           {
                if(data_array[i].emailid==s_emailid)
                {
                document.getElementById("emailid_exist_label").style.display="block"
                return false;
                }
                else
                {
        ...
        function validate_email()
        {
            ...
            if(re.test(emailid))
            {
               ...
               return( unique_emailid());
              
            }
            else
            {
                document.getElementById("emailid_label").style.display="block"
                return false;
            }
        }
        function validate_mobilenumber()
        {
            ...
            if(mobilenumber.match(phoneno))
            {
              ...
              {  
                document.getElementById("mbnumber_label").style.display="block"
                 return ;  
               }  
	...
	function validate_confirmpassword()
        {
            ...
            {
		      document.getElementById("rpassword_label").style.display="block"
               return; 
            }
	...
	function validate_name()
        {
            ...
            if(fname!="")
            {
                ...
                fname_label=document.getElementById("fname_label").style.display="none"
                return true;
            }
            else
            {
		        fname_label=document.getElementById("fname_label").style.display="block"
               return; 
            }
	...
	function validate_lastname()
        {
            ...
            {
		      document.getElementById("lname_label").style.display="block"
               return; 
            }
